...
const Home: React.FC = () => {
  ...
  return (
    <div>
      <header
        className="
      w-full h-50 sm:h-74 sm:bg-mobile-light bg-desktop-light bg-cover bg-no-repeat transition-all duration-300"
      >
        <div className="max-w-xl  mx-auto p-4 ">
          <h1 className="text-4xl text-white text-center font-bold py-8">
            Task Manager
          </h1>
